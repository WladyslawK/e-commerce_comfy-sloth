...
export const productsReducer = (state = productsInitialState, action: ActionsType
):
  productsStateType => {
  switch (action.type) {
...
export const setProductsAC = (products: ProductsResponseType[]) => ({type: SET_PRODUCTS, payload: {products}} as const)
